...
namespace MBN.Modules
{
    public partial class TinyFileSystem
    {
        ...
        public class Utilities
        {
            ...
            private static void Sort(String[] array, Int32 l, Int32 r)
            {
                const Int32 m = 4;
            ...
            private static void InsertionSort(String[] array, Int32 lo, Int32 hi)
            {
                Int32 i;
            ...
            private static void Swap(IList list, Int32 left, Int32 right)
            {
                var swap = list[left];
