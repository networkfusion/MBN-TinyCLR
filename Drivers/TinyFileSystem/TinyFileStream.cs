    ...
    public partial class TinyFileSystem
    {
        ...
        public class TinyFileStream : Stream
        {
            ...
            public override Int32 Read(Byte[] array, Int32 offset, Int32 count)
            {
                ...
                var bytesRead = _fs.Read(_fileRef, _filePointer, array, offset, count);
            ...
            public override Int64 Seek(Int64 offset, SeekOrigin origin)
            {
                ...
                var newFilePointer = _filePointer;
                ...
                if (newFilePointer < 0 || newFilePointer > _fileRef.FileSize)
                    throw new IOException(StringTable.Error_OutOfBounds, (Int32) IOException.IOExceptionErrorCode.Others);
            ...
            {
                if (_fs == null || _fileRef == null || (_fileRef != null && _fileRef.OpenCount == 0))
