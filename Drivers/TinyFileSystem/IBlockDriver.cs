...
namespace MBN.Modules
{
    public partial class TinyFileSystem
    {
        ...
        public interface IBlockDriver
        {
            ...
            void EraseSector(Int32 sectorId);
            ...
            void Read(UInt16 clusterId, Int32 clusterOffset, Byte[] data, Int32 index, Int32 count);
            ...
            void Write(UInt16 clusterId, Int32 clusterOffset, Byte[] data, Int32 index, Int32 count);

            /// <summary>
            /// Full capacity of the device in bytes.
            /// </summary>
            Int32 DeviceSize { get; }
