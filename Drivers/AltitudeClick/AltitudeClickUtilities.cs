...
namespace MBN.Utilities
{
    ...
    public abstract class Temperature
    {
        ...
        /// </code>
        /// </example>
        public static System.Single ConvertTo(TemperatureUnits fromUnit, TemperatureUnits toUnit, System.Single temperature)
        {
            switch (fromUnit)
            {
                ...
                case TemperatureUnits.Fahrenheit:
                    {
                        switch (toUnit)
                        {
                            ...
                            case TemperatureUnits.Fahrenheit:
                                return temperature;
                            case TemperatureUnits.Kelvin:
                                return (System.Single)(((temperature - 32) / 1.8000) + 273.15);
                        }
                        break;
                    }
            }
    ...
    public abstract class Pressure
    {
        ...
        /// </code>
        /// </example>
        public static System.Single ToInchesHg(System.Single pascals) => pascals / 3386.389F;
        ...
        /// </code>
        /// </example>
        public static System.Single ToHectoPascals(System.Single pascals) => pascals * 0.01F;
    }
    ...
    public abstract class Altitude
    {
        ...
        /// </code>
        /// </example>
        public static System.Int32 ToFeet(System.Int32 meters) => (System.Int32)(meters * 3.2808F);
    }
}