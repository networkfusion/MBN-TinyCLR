...
namespace MBN.Modules
{
	...
	public struct Rect
	{
		...
		public Int32 Width
		{
            ...
            set
			{
				if (value < 0) throw new ArgumentOutOfRangeException(nameof(value), @"Width cannot be less than 0.");
				_w = value;
			}
		}
		...
		public Int32 Height
		{
            ...
            set
			{
				if (value < 0) throw new ArgumentOutOfRangeException(nameof(value), @"Height cannot be less than 0.");
				_h = value;
			}
		}
		...
		public void Combine(Rect newRect)
		{
			...
			Int32 x1 = _x < newRect.X ? _x : newRect.X;
			Int32 y1 = _y < newRect.Y ? _y : newRect.Y;
			Int32 x2 = _x + Width > newRect.X + newRect.Width ? _x + _w : newRect.X + newRect.Width;
			Int32 y2 = _y + Height > newRect.Y + newRect.Height ? _y + _h : newRect.Y + newRect.Height;
			_x = x1;
			_y = y1;
			_w = x2 - x1;
			_h = y2 - y1;
		...
		public Rect Combine(Rect region1, Rect region2)
		{
			...
			Int32 x1 = region1.X < region2.X ? region1.X : region2.X;
			Int32 y1 = region1.Y < region2.Y ? region1.Y : region2.Y;
			Int32 x2 = region1.X + region1.Width > region2.X + region2.Width
				? region1.X + region1.Width
				: region2.X + region2.Width;
			Int32 y2 = region1.Y + region1.Height > region2.Y + region2.Height
		...
		/// </code>
		/// </example>
		public Boolean Contains(Int32 pointX, Int32 pointY)
		{
		...
		public Rect Intersection(Rect region1, Rect region2)
		{
			...
			Int32 r1V2 = region1.X + region1.Width;
			Int32 r2V2 = region2.X + region2.Width;
		...
		/// </code>
		/// </example>
		public Boolean Equals(Rect rect1)
		{
	...
	public struct Size
	{
		...
		/// </code>
		/// </example>
		public void Shrink(Int32 subtractWidth, Int32 subtractHeight)
		{
			Width += subtractWidth;
			if (Width < 0) Width = 0;
