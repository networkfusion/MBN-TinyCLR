/*
 * WeatherClick driver for TinyCLR 2.0 
 * 
...
namespace MBN.Modules
{
    ...
    /// <summary>
    ///  Main class for the WeatherClick driver
    ...
    ///         {
    ///             _sensor = new WeatherClick(Hardware.SocketOne, WeatherClick.I2CAddresses.Address0)
    ///             {
    ...
    /// </code>
    /// </example>
    public sealed class WeatherClick : IPressure, ITemperature, IHumidity
    {
        #region CTOR

        /// <summary>
        ///     Initializes a new instance of the <see cref="WeatherClick" /> class.
        /// </summary>
        ...
        public Int32 ReadAltitude()
        {
            return (Int32) Math.Round(
                44330 * (1.0 - Math.Pow(ReadPressure(PressureCompensationModes.Uncompensated) / ReadPressure(),
                             0.1903)));
        }
